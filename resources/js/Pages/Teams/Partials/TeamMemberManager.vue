    ...
    <div>
        <div v-if="team.users.length > -1">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                ...
                <template #description>
                    Semua orang yang menjadi bagian dari bisnis ini.
                </template>
        ...
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <FormSection @submitted="addTeamMember">
                <template #title>
                    Tambahkan mitra bisnis
                </template>

                <template #description>
                    Tambahkan mitra bisnis baru ke bisnis Anda sehingga mereka dapat berkolaborasi dengan Anda.
                </template>

                <template #form>
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            Silakan berikan alamat email orang yang ingin Anda tambahkan ke bisnis ini.
                        </div>
                    </div>
                    ...
                    <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
                        <InputLabel for="roles" value="Posisi" />
        ...
        <div v-if="team.team_invitations.length > 0 && userPermissions.canAddTeamMembers">
            ...
            <ActionSection class="mt-10 sm:mt-0">
                ...
                <template #description>
                    Orang-orang ini telah diundang ke bisnis Anda dan telah dikirim undangan. Mereka dapat bergabung dengan bisnis anda dengan menerima undangan email.
                </template>
